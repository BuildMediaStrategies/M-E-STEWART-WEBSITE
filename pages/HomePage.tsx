      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 sm:mb-12 text-center">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold uppercase text-brand-darkBlue">
            Find Us in <span className="inline-block relative">Deal<div className="h-1 bg-brand-blue mt-2 absolute left-0 right-0"></div></span>
          </h2>
          <p className="mt-4 sm:mt-6 text-sm sm:text-base text-brand-slate max-w-xl mx-auto">
            Visit our Deal office or contact us for a free consultation
          </p>
        </div>
